...
%  series_z_b = fun_plot(yy,ypf,i,a,m,Tobs,graph_title,V,P,ZZ);
 ...
 series_shock_mp = fun_plot_shock(yy,ypf,i,a,m,Tobs,graph_title,V,P,ZZ,shock_art);
 
 i = 10;
 graph_title={'TFP Shock : Particle Filter '};
 series_shock_a = fun_plot_shock(yy,ypf,i,a,m,Tobs,graph_title,V,P,ZZ,shock_art);
 
 i = 11;
 graph_title={'Preference Shock : Particle Filter '};
 series_shock_b = fun_plot_shock(yy,ypf,i,a,m,Tobs,graph_title,V,P,ZZ,shock_art);
