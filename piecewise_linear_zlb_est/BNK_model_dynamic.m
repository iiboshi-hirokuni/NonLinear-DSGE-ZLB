function [residual, g1, g2, g3] = BNK_model_dynamic(y, x, params, steady_state, it_)
%
...
T81 = (params(7)+params(9)/(1-params(10)*exp((-params(5)))))^(-1);
T85 = exp((-params(5)))*params(10)*params(9)*T81/(1-params(10)*exp((-params(5))));
T103 = (params(9)+exp((-params(5)))*params(10)*params(9)*params(7)*T81/(1-params(10)*exp((-params(5)))))*params(15);
lhs =y(5);
...
residual(4)= lhs-rhs;
lhs =y(10)/params(2);
rhs =y(7)*params(7)*(1/params(21)-T85)+(1-params(21)*params(16))/params(21)*y(12)+T103*y(11);
residual(5)= lhs-rhs;
lhs =y(7);
rhs =T85*(y(1)-y(11));
residual(6)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(4,8)=1;
  g1(4,9)=(-1);
  g1(5,7)=(-(params(7)*(1/params(21)-T85)));
  g1(5,10)=1/params(2);
  g1(5,11)=(-T103);
