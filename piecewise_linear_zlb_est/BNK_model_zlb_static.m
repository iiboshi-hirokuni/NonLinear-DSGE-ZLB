function [residual, g1, g2] = BNK_model_zlb_static(y, x, params)
%
...
T76 = (params(7)+params(9)/(1-params(10)*exp((-params(5)))))^(-1);
T80 = exp((-params(5)))*params(10)*params(9)*T76/(1-params(10)*exp((-params(5))));
T98 = (params(9)+exp((-params(5)))*params(10)*params(9)*params(7)*T76/(1-params(10)*exp((-params(5)))))*params(15);
lhs =y(1);
...
residual(4)= lhs-rhs;
lhs =y(6)/params(2);
rhs =y(3)*params(7)*(1/params(21)-T80)+(1-params(21)*params(16))/params(21)*y(8)+T98*y(7);
residual(5)= lhs-rhs;
lhs =y(3);
rhs =T80*(y(2)-y(7));
residual(6)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(4,4)=1;
  g1(5,3)=(-(params(7)*(1/params(21)-T80)));
  g1(5,6)=1/params(2);
  g1(5,7)=(-T98);
