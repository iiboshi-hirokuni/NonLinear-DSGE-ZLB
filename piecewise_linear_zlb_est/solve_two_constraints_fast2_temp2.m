...
function [ zdatalinear_ zdatapiecewise_ zdatass_ oo00_  M00_ oo10_ M10_ oo01_ M01_ oo11_ M11_ ] = ...
  solve_two_constraints_fast2_temp2(modnam_00_,modnam_10_,modnam_01_,modnam_11_,...
    ...
    oo00_, M00_, oo10_, M10_, oo01_, M01_, oo11_, M11_)
...
for ishock_ = 1:nshocks
    ...
    while (changes_ & iter_<maxiter_)
        ...
        [zdatalinear_]=mkdatap_anticipated_2constraints_fast(nperiods_,decrulea,decruleb,...
            cof_,Jbarmat_,...
...
%          end
    ...
    if changes_ ==1
        %error('Did not converge -- increase maxiter')
    end
