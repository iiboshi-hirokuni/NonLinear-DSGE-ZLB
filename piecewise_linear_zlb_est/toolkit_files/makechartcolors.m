function makechartcolors(colors,titlelist,legendlist,figlabel,yearshock,ylabels,...
...
elseif (nvars==7 | nvars==8)
    nrows = 4;
    ncols = 2;
elseif nvars>8 & nvars<=9;
    nrows = 3;
    ncols = 3;
elseif nvars==10 
    nrows = 5;
    ncols = 2;
elseif nvars>10 & nvars<=12;
    nrows = 3;
    ncols = 4;
...
for i = 1:nvars
    ...
    h1=plot(xvalues,zdata1(:,i),colors(1),...
        xvalues,zdata2(:,i),colors(2),...
        xvalues,zdata3(:,i),colors(3),...
        xvalues,zdata4(:,i),'g',...
        xvalues,zdata5(:,i),'g',...
        xvalues,zdata6(:,i),'c',...
        xvalues,zdata7(:,i),'y');
    ...
    title(deblank(titlelist(i,:)),'Fontsize',11);
    ylabel(deblank(ylabels(i,:)))
