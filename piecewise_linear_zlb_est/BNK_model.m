...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('BNK_model_static');
erase_compiled_function('BNK_model_dynamic');
...
var_list_=[];
var_list_ = 'data_y';
var_list_ = char(var_list_, 'data_pi');
var_list_ = char(var_list_, 'data_r');
info = stoch_simul(var_list_);
save('BNK_model_results.mat', 'oo_', 'M_', 'options_');
