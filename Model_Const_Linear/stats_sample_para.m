...
para_phi = ( para_Resamp(:,7)-1 ).*( para_Resamp(:,6)+para_Resamp(:,1) )./para_Resamp(:,8)./(1+para_Resamp(:,9)/100);

             
parasim = [ para_Resamp para_phi post_Resamp(:,1:2) stock_accept_rate' ] ;

parasim(:,15:17) = 100*parasim(:,15:17);
