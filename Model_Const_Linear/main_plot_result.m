...
% Load parameters, steady state and grids
  file_name = ['./output/May_15_2017/save_para_I0_def_'...
                    num2str(zlbflag)  num2str(policy_flag) '_' ...
                    num2str(nsim) '_' num2str(nparticles)  ];  
                
%   file_name = ['./output/Mar_17_2017/save_para_I0_def_'...
%                     num2str(zlbflag)  num2str(policy_flag) '_' ...
%                     num2str(nsim) '_' num2str(nparticles)  ];  
 ...
 P.tol     = 1e-4; %10;     % Convergence criterion
%   P.omega   = 10;
%   P.kappa   = 0.10;
...
%%--------------------------------------------------------------------------
 ...
 disp('Start NK Model with Time Iteration (Linear Interpolation)')
  P.disp_it=1;
  [ pf, ~ ] = solve_model_CL(P,S,G,zlbflag,policy_flag,tstart);
