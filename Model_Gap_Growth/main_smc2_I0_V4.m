...
if m_err_flag == 1  
    m_error = [0.005 0.005 0.0025 0.005]; % measurement errors are of the sizes of 1%, 1%, 0.5% of SD, respectively
elseif m_err_flag == 2  
    m_error = 1*[0.005 0.005 0.0025 0.005];
end    
    
HH = 100^2*diag([ (m_error(1)*Pr.pmean(18))^2 (m_error(2)*Pr.pmean(19))^2 ...
                  (m_error(3)*Pr.pmean(20))^2 (m_error(4)*Pr.pmean(18))^2 ]);
...
% save parameters
  ...
  file_name = ['./output/save_para_I0_V4_'  num2str(zlbflag)  num2str(policy_flag) '_' ...
